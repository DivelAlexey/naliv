...
use app\models\RequestedTypeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * RequestedTypeController implements the CRUD actions for RequestType model.
 */
class RequestedTypeController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new RequestedTypeSearch();
